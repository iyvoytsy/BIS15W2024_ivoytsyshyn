...
## # A tibble: 12,370 × 3
## # Groups:   country [204]
##    country common_name                  n_nas
##    <chr>   <chr>                        <int>
##  1 Albania Angelsharks, sand devils nei    45
##  2 Albania Atlantic bonito                 45
##  3 Albania Barracudas nei                  50
##  4 Albania Blue and red shrimp             47
##  5 Albania Blue whiting(=Poutassou)        47
##  6 Albania Bluefish                        50
##  7 Albania Bogue                           33
##  8 Albania Caramote prawn                  45
##  9 Albania Catsharks, nursehounds nei      50
## 10 Albania Common cuttlefish               45
## # ℹ 12,360 more rows
```
...
```r
#fisher1 <- fisher %>%
  #mutate(combined_factor = as.factor(interaction(country, isscaap_group_number, fao_major_fishing_area, asfis_species_number)))
```
...
```
## # A tibble: 1,546 × 2
## # Groups:   asfis_species_name [1,546]
...
##   <chr>   <chr>              <dbl> <dbl>
## 1 Morocco Sardina pilchardus   947  1994
```
...
```
## # A tibble: 1 × 5
##   country common_name     asfis_species_name catch  year
##   <chr>   <chr>           <chr>              <dbl> <dbl>
## 1 India   Cephalopods nei Cephalopoda           94  2011
```
...
##   country common_name        asfis_species_name  catch  year
##   <chr>   <chr>              <chr>               <dbl> <dbl>
## 1 China   Largehead hairtail Trichiurus lepturus  8221  2011
```
...
```
## # A tibble: 1,546 × 2
##    asfis_species_name      mean_catch_tons
##    <chr>                             <dbl>
