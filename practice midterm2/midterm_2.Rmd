...
7. What are the 5 procedures associated with highest risk of 30-day mortality(mort30) AND how do they compare with the 5 procedures with highest risk of complication(complication)? (hint: no need for a plot here)
```{r}
surgery %>%
  group_by(ahrq_ccs) %>%
