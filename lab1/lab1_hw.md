...
R is a language for statistics and data analysis, RStudio is a tool that makes it easier to use R that appered afte it. GitHub is a website where programmers can share and collaborate on code.
